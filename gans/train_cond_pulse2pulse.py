...
parser.add_argument("--checkpoint_path", default=r"/home/zyw/gans/P2P/p2p/checkpoints/checkpoint_epoch_180.pth", help="Check point path to retrain or test models")
...
def prepare_data():#定义了一个名为prepare_data的函数，用于准备数据集并创建数据加载器（dataloader）。
    dataset = np.load(r"/home/zyw/gans/dataset/data/train_ptbxl_1000.npy")
    ...
    labels = np.load(r"/home/zyw/gans/dataset/label/1000_train_labels.npy")
